...
namespace wind
{
    ...
    size_t DescriptorLayoutCache::DescriptorLayoutInfo::hash() const
    {
        ...
        {
            size_t bindHash = b.binding | (uint32_t)b.descriptorType << 8 | (uint32_t)b.descriptorCount << 16 |
    ...
    DescriptorLayoutCache::CreateDescriptorsetlayout(const vk::DescriptorSetLayoutCreateInfo layoutInfo)
    {
        ...
        {
            // sort our binding
            std::sort(ownLayoutInfo.bindings.begin(),
                      ownLayoutInfo.bindings.end(),
